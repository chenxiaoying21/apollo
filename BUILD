...
install(
    ...
    deps = if_gpu([
        ...
        "//modules/planning/planning_base:install",
        ...
        "//modules/planning/traffic_rules:install",
...
install_src_files(
    ...
    deps = if_gpu([
        ...
        "//modules/planning/planning_base:install_src",
        ...
        "//modules/planning/traffic_rules:install_src",
        "//modules/planning/tasks:install_src",
        "//modules/planning/scenarios:install_src",
    ], [
        "//cyber:install_src",
        "//tools:install_src",
        "//modules/common:install_src",
