...
#include "modules/planning/tasks/path_reuse_decider/path_reuse_decider.h"
...
class PathReuseDeciderTest : public ::testing::Test {
 ...
 protected:
  PathReuseDeciderConfig config_;
  std::shared_ptr<DependencyInjector> injector_;
};

TEST_F(PathReuseDeciderTest, Init) {
  PathReuseDecider path_reuse_decider;
  path_reuse_decider.Init(
      "scenarios/lane_follow_scenario/conf/lane_follow_stage",
      "PATH_REUSE_DECIDER", injector_);
  EXPECT_EQ(path_reuse_decider.Name(), "PATH_REUSE_DECIDER");
}
