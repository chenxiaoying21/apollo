...
#include "modules/planning/tasks/piecewise_jerk_path_optimizer/proto/piecewise_jerk_path_optimizer.pb.h"
...
class PiecewiseJerkPathOptimizer : public PathOptimizer {
 ...
 private:
  PiecewiseJerkPathOptimizerConfig config_;
};

CYBER_PLUGIN_MANAGER_REGISTER_PLUGIN(
    apollo::planning::PiecewiseJerkPathOptimizer, Task)
