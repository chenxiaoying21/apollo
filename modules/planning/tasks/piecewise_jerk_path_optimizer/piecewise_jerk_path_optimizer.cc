...
#include "modules/planning/tasks/piecewise_jerk_path_optimizer/piecewise_jerk_path_optimizer.h"
...
bool PiecewiseJerkPathOptimizer::Init(
  ...
  return Task::LoadConfig<PiecewiseJerkPathOptimizerConfig>(&config_);
}
...
bool PiecewiseJerkPathOptimizer::OptimizePath(
  ...
  if (!success) {
    ...
    AERROR << "dl bound" << config_.lateral_derivative_bound_default()
