...
class PathBoundsDeciderUtil {
 public:
   ...
   */
  static bool UpdatePathBoundaryWithBuffer(size_t idx, double left_bound,
                                           double right_bound,
  ...
  static bool GetBoundaryFromStaticObstacles(
      const ReferenceLineInfo& reference_line_info,
      const SLState& init_sl_state, PathBound* const path_boundaries,
  ...
  static bool GetBoundaryFromSelfLane(
      const ReferenceLineInfo& reference_line_info,
      const SLState& init_sl_state, const bool is_extend_adc_bound,
      const double extend_buffer, PathBound* const path_bound);
