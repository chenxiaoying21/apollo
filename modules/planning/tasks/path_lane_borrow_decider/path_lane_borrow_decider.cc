...
#include "modules/planning/tasks/path_lane_borrow_decider/path_lane_borrow_decider.h"
...
bool PathLaneBorrowDecider::Init(
  ...
  return Decider::LoadConfig<PathLaneBorrowDeciderConfig>(&config_);
}
