...
#include "modules/planning/tasks/path_bounds_decider/proto/path_bounds_decider.pb.h"
...
CYBER_PLUGIN_MANAGER_REGISTER_PLUGIN(apollo::planning::PathBoundsDecider, Task)
