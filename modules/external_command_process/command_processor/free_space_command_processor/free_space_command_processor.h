...
class FreeSpaceCommandProcessor
    : public MotionCommandProcessorBase<FreeSpaceCommand> {
 private:
  /**
...
CYBER_PLUGIN_MANAGER_REGISTER_PLUGIN(
    apollo::external_command::FreeSpaceCommandProcessor, CommandProcessorBase)
