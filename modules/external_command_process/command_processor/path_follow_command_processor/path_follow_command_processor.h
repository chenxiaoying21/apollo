...
#include "modules/external_command_process/command_processor/command_processor_base/motion_command_processor_base.h"

namespace apollo {
namespace external_command {

class PathFollowCommandProcessor
    : public MotionCommandProcessorBase<PathFollowCommand> {
 private:
  /**
   ...
   */
  bool Convert(const std::shared_ptr<PathFollowCommand>& command,
...
CYBER_PLUGIN_MANAGER_REGISTER_PLUGIN(
    apollo::external_command::PathFollowCommandProcessor, CommandProcessorBase)
