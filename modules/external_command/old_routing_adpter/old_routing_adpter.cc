...
/**
 * @file old_routing_adpter.cc
 */

#include "modules/external_command/old_routing_adpter/old_routing_adpter.h"

#include <limits>

#include "modules/external_command/old_routing_adpter/proto/old_routing_adpter.pb.h"

#include "modules/map/hdmap/hdmap_util.h"

/**
 * @namespace apollo::old_routing_adpter
 * @brief apollo::old_routing_adpter
 */
namespace apollo {
namespace old_routing_adpter {
...
OldRoutingAdapter::OldRoutingAdapter()
...
bool OldRoutingAdapter::Init() {
  ...
  routing_response_writer_ = node_->CreateWriter<routing::RoutingResponse>(
...
void OldRoutingAdapter::OnPlanningCommand(
